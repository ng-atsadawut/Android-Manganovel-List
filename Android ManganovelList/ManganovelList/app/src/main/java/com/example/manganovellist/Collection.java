...
public class Collection extends AppCompatActivity implements MySQLConnect.CallBack {
...
//        Log.d("J onCreate", "Start onCreate");
    ...
    private void Logout() {
        ...
        finish();
        startActivity(new Intent(Collection.this, LoginActivity.class));
    }
...
//        dataView.setAdapter(new ArrayAdapter<String>(this, android.R.layout.simple_list_item_1,items));
    ...
    public void init(){
         ...
         */
        getUID();
        String action = "all_by_user";
        String message = "";
        String SQL = "";
        String UID = Uid;
        Utils.showProgressDialog(this);
        dataView = (ListView) findViewById(R.id.dataViewID2);
        mySQLConnect = new MySQLConnect(Collection.this, this);//init this class.
